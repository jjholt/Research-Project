        ...
        \begin{tikzpicture}[scale=0.95]
            \begin{axis}[
                ...
                \addplot+[ no marks] table [col sep=comma, y expr = 1e9*\thisrowno{3}, x expr = 1e3*\thisrowno{0}]
                    {Modelling/Frequencies/csv/Job-22_900-Hz-6-periods_Node SPIGOT-1.8.csv};
                \addlegendentry{Spigot}
                \addplot+[ no marks] table [col sep=comma, y expr = 1e9*\thisrowno{3}, x expr = 1e3*\thisrowno{0}]
                    {Modelling/Frequencies/csv/Job-22_900-Hz-6-periods_Node STEM-1.17.csv};
                \addlegendentry{Stem}
                \addplot+[ no marks] table [col sep=comma, y expr = 1e9*\thisrowno{3}, x expr = 1e3*\thisrowno{0}]
                {Modelling/Frequencies/csv/Job-22_900-Hz-6-periods_Node COLLAR-1.7.csv};
                \addlegendentry{Collar}
            \end{axis}
        \end{tikzpicture}
        \caption{900 Hz}
